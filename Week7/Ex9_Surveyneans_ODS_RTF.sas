*Ex9_Surveymeans_ODS_RTF.sas;
OPTIONS nocenter nodate nonumber ps=58 ls=132  ;
libname out "D:\A_Data";
libname library "D:\A_Data";
ods graphics off;
...
run;
proc format;
value n_age_fmt .='All Ages' 1='0-17 yrs'
	 2='18-64 yrs'  3='65+ yrs';
value n_sex_fmt .='Both Sexes'	 1='Male' 2='Female';
run;
...
ods rtf file="D:\A_Data\Surveymeans.rtf" style=styles.test bodytitle;   
