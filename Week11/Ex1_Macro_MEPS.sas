...
libname pufmeps  'C:\SASCourse\Week11' access=readonly;
libname new 'C:\SASCourse\Week11';
OPTIONS LS=132 PS=79 NODATE FORMCHAR="|----|+|---+=|-/\<>*" PAGENO=1;
FILENAME MYLOG "C:\SASCourse\Week11\Ex1_Macro_MEPS_log.TXT";
FILENAME MYPRINT "C:\SASCourse\Week11\Ex1_Macro_MEPS_OUTPUT.TXT";
