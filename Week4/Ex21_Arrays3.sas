...
;
proc print data=Implicit_array; 
...
Albany        2.36 	2.27 	2.93 	2.99
;
proc print data=work.Explicit_array; 
...
Albany        2.36 	2.27 	2.93 	2.99
;
proc print data=work.Dim_function; 
...
G5 	 2.36 	2.27 	1.93
;
proc print data=work.score_to_grade;
